...
window.rocketform = rocketform = $.rocketform = function(){
    ...
    arguments.callee.previewsummbox_shadowBox = function () {
        var style,s_x,s_y,s_blur,s_st,s_color;
        
         //status
         s_st=this.getUiData3('summbox','form_shadow','show_st');
         s_x=this.getUiData3('summbox','form_shadow','h_shadow');    
         s_y=this.getUiData3('summbox','form_shadow','v_shadow');
         s_blur=this.getUiData3('summbox','form_shadow','blur');
         s_color=this.getUiData3('summbox','form_shadow','color');
          
          if(parseInt(s_st)===1){
              style=s_x+'px '+s_y+'px '+s_blur+'px '+s_color;
             $('#uifm-sticky-sidebar-box').css('box-shadow',style);
          }else{
             $('#uifm-sticky-sidebar-box').removeCss('box-shadow');
          }
    };
    ...
    arguments.callee.previewsummbox_elementBorderRadius = function () {
        var show_st=this.getUiData3('summbox','form_border_radius','show_st');
        var size=this.getUiData3('summbox','form_border_radius','size');
        if(parseInt(show_st)===1){
            $('#uifm-sticky-sidebar-box').css('border-radius',size+'px');
        }else{
            $('#uifm-sticky-sidebar-box').removeCss('border-radius'); 
        }
 ...
 arguments.callee.previewfield_helpblock_hidetooltip = function () {
    ...
    arguments.callee.previewsummbox_elementBorder = function () {
       
        var show_st=this.getUiData3('summbox','form_border','show_st');
        var color=this.getUiData3('summbox','form_border','color');
        var style=this.getUiData3('summbox','form_border','style');
        var width=this.getUiData3('summbox','form_border','width');
        var border_sty;
        if(parseInt(show_st)===1){
            if(parseInt(style)===1){
            border_sty='solid ';
            ...
            border_sty+=color+' '+width+'px';
            $('#uifm-sticky-sidebar-box').css('border',border_sty);
 
        }else{
            $('#uifm-sticky-sidebar-box').removeCss('border'); 
        }
    ...
    arguments.callee.previewform_summboxBackground = function () {
        var show_st=this.getUiData3('summbox','form_background','show_st');
        var type=this.getUiData3('summbox','form_background','type');
        var start_color=this.getUiData3('summbox','form_background','start_color');
        var end_color=this.getUiData3('summbox','form_background','end_color');
        var solid_color=this.getUiData3('summbox','form_background','solid_color');
        var skin_bg_imgurl=this.getUiData3('summbox','form_background','image');
        if(parseInt(show_st)===1){
           switch (parseInt(type)) {
                case 2:
                    //gradient
                    $('#uifm-sticky-sidebar-box').css({
                            'background': start_color, 
                            'background-image': "-webkit-linear-gradient(top, "+start_color+", "+end_color+")", 
                            'background-image': "-moz-linear-gradient(top, "+start_color+", "+end_color+")",
                            'background-image': "-ms-linear-gradient(top, "+start_color+", "+end_color+")",
                ...
                default:
                    //solid
                    if(solid_color){
                       $('#uifm-sticky-sidebar-box').css('background',solid_color);
                    }
                    
                break;
            }
          if(skin_bg_imgurl){
               $('#uifm-sticky-sidebar-box').removeCss('background-image');
               $('#uifm-sticky-sidebar-box').css({
                                'background-image': "url('"+skin_bg_imgurl+"')", 
                                'background-repeat': "repeat"
                            });
           ...
           $('#uifm-sticky-sidebar-box').removeCss('background'); 
           $('#uifm-sticky-sidebar-box').removeCss('background-image');
 ...
 var section2,option,option2,tmp_store;
            ...
            case 'calculation':
                switch(String(section2)) {
                    case 'enable_st':
                        ...
                        break;
                    case 'variables':
                        //add formula to variable content
                        break;
                }
            break;
            case 'summbox':
                ...
                switch(String(section2)) {
                        ...
                        case 'skin_box':
                        case 'skin_text':
                            this.previewform_refreshsummbox();
                        break;
                        case 'form_shadow':
                             switch(String(option)) {
                                    ...
                                    case 'h_shadow':  
                                    case 'blur':
                                        this.previewsummbox_shadowBox(obj);
                                        break; 
                                    default:
                                }   
                        break;
                         case 'form_background':
                            ...
                            switch(String(option)) {
                                    ...
                                    case 'solid_color':
                                    case 'image':
                                        this.previewform_summboxBackground();
                                        break; 
                                    default:
                                }
                            break;
                        case 'form_border_radius':
                            ...
                            switch(String(option)) {
                                    case 'show_st':
                                    case 'size':
                                        this.previewsummbox_elementBorderRadius();
                                        break; 
                                    default:
                                }
                            break;
                        case 'form_border':
                            ...
                            switch(String(option)) {
                                    ...
                                    case 'style':
                                    case 'width':
                                        this.previewsummbox_elementBorder();
                                    break; 
                                    default:
                                }
                            break;
            ...
            case 'input3':
                ...
                switch(String(option)) {
                        ...
                        case 'val_align':
                            switch (parseInt(value)) {
                                    case 1:
                                        obj.find('.uifm-input3-customhtml').css('text-align','center');
                                        break; 
                                    case 2:
                                        obj.find('.uifm-input3-customhtml').css('text-align','right');
                                        break;
                                    case 0:    
                                    default:
                                        obj.find('.uifm-input3-customhtml').css('text-align','left');
                                        break;
                                }
             ...
             case 'el13_background':
              ...
              case 'el13_border':
                ...
                switch(String(option)) {
                        case 'enable_st':
                        case 'lbl_show_st':
                        case 'lbl_show_format':
                        case 'color':
                        case 'font':
                        case 'font_st':
                          /*here go process price*/
                          /*price*/
                          this.previewfield_priceslabel(obj);
                           break;
                        default:
                    }
                break;
    ...
    arguments.callee.previewfield_priceslabel = function (obj) {
        var f_type=obj.attr('data-typefield');
        
            switch(parseInt(f_type)){
                case 8:
                    /*radio button*/
                    obj.find('.uifm-input2-wrap .sfdc-radio label .uifm_frm_price_lbl_cont').html(rocketform.pricesettings_labelformat(obj));
                break;
                case 9:
                    /*checkbox*/
                    obj.find('.uifm-input2-wrap .sfdc-checkbox label .uifm_frm_price_lbl_cont').html(rocketform.pricesettings_labelformat(obj));
                break;
                case 10:
                    /*select*/
                    obj.find('.uifm-input2-wrap .uifm_frm_price_lbl_cont').html(rocketform.pricesettings_labelformat(obj));
                break;
                case 11:
                    /*multiselect*/
                    obj.find('.uifm-input2-wrap .uifm_frm_price_lbl_cont').html(rocketform.pricesettings_labelformat(obj));
                ...
                case 16:
                    /*slider*/
                    obj.find('.uifm-input-container .uifm_frm_price_lbl_cont').html(rocketform.pricesettings_labelformat(obj));
                break;
                case 18:
                    /*spinner*/
                    obj.find('.uifm-input-container .uifm_frm_price_lbl_cont').html(rocketform.pricesettings_labelformat(obj));
 ...
 var section2,option,option2,tmp_store;
       ...
       switch(String(section)) {
           case 'main':
                switch(String(section2)) {
                    ...
                    case 'preload_noconflict':
                        ...
                        break;
                    case 'price_st':
                        var main_pricest=(parseInt(this.getUiData2('main','price_st'))===1)?true:false;
                        $('#uifm_frm_main_pricest').bootstrapSwitchZgpb('state',main_pricest);
                        break;
                    case 'price_currency_symbol':
                        var main_currency_symbol=this.getUiData2('main','price_currency_symbol');
                        if(main_currency_symbol){
                            $('#uifm_frm_main_price_currency_symbol').val(main_currency_symbol);
                        }
                        break;
                    case 'price_currency':
                        var main_currency=this.getUiData2('main','price_currency');
                        if(main_currency){
                            $('#uifm_frm_main_price_currency').val(main_currency);
                        }
                        break;
                    case 'price_format_st':
                        var main_currency_format_st=(parseInt(this.getUiData2('main','price_format_st'))===1)?true:false;
                        if(main_currency_format_st){
                            $('#uifm_frm_main_price_format_st').bootstrapSwitchZgpb('state',main_currency_format_st);
                        }
                        break;
                    case 'price_sep_decimal':
                        var main_currency_decimal=this.getUiData2('main','price_sep_decimal');
                        if(main_currency_decimal){
                            $('#uifm_frm_main_price_decimal').val(main_currency_decimal);
                        }
                        break;
                    case 'price_sep_thousand':
                        var main_currency_thousand=this.getUiData2('main','price_sep_thousand');
                        if(main_currency_thousand){
                            $('#uifm_frm_main_price_thousand').val(main_currency_thousand);
                        }
                        break;
                    case 'price_sep_precision':
                        var main_currency_precision=this.getUiData2('main','price_sep_precision');
                        if(main_currency_precision){
                            $('#uifm_frm_main_price_precision').val(main_currency_precision);
                        }

                        break;
                    case 'price_tax_st':
                        //tax
                        var main_currency_tax_st=(parseInt(this.getUiData2('main','price_tax_st'))===1)?true:false;
                        if(main_currency_tax_st){
                            $('#uifm_frm_main_price_tax_st').bootstrapSwitchZgpb('state',main_currency_tax_st);
                        }
                        break;
                    case 'price_tax_val':
                        var main_currency_tax_val=this.getUiData2('main','price_tax_val');
                        if(main_currency_tax_val){
                            $('#uifm_frm_main_price_tax_val').val(main_currency_tax_val);
                        }
                        break;
                    case 'payment_st':
                        var main_paymentst=(parseInt(this.getUiData2('main','payment_st'))===1)?true:false;
                        $('#uifm_frm_main_paymentst').bootstrapSwitchZgpb('state',main_paymentst);
                        break;
                    case 'pdf_show_onpage':
                        var main_pdf_onpage=(parseInt(this.getUiData2('main','pdf_show_onpage'))===1)?true:false;
                        $('#uifm_frm_main_pdf_show_onpage').bootstrapSwitchZgpb('state',main_pdf_onpage);
                        break;   
                    case 'pdf_charset':
           ...
           case 'invoice':
                switch(String(section2)){
                    case 'from_text1':
                        tmp_suffix='1';
                        if(this.getUiData2('invoice','from_text'+tmp_suffix)){
                                $('#uifm_frm_inv_from_text'+tmp_suffix).val(decodeURIComponent(this.getUiData2('invoice','from_text'+tmp_suffix)));
                            }
                         break;   
                    case 'from_text2':
                        tmp_suffix='2';
                    ...
                    case 'to_text1':
                        tmp_suffix='1';
                            if(this.getUiData2('invoice','to_text'+tmp_suffix)){
                                $('#uifm_frm_inv_to_text'+tmp_suffix).val(decodeURIComponent(this.getUiData2('invoice','to_text'+tmp_suffix)));
                            }
                        break;
                    case 'to_text2':
                        tmp_suffix='2';
                ...
                switch(String(section2)){
                     case 'setting':
                        switch(String(option)) {
                            case 'enable_st':
                                if(parseInt(value)===1){
                                tab.find('#uifm_frm_summbox_st').bootstrapSwitchZgpb('state', true);
                                }else{
                                tab.find('#uifm_frm_summbox_st').bootstrapSwitchZgpb('state', false);    
                                }
                                //trigger resize - For grid
                                $(window).trigger('resize');
                                break;
                            case 'pos':
                                tab.find('#uifm_frm_summbox_skin_pos').selectpicker('val', value);
                                break; 
                        }
                        break;
                     case 'skin_box':
                         switch(String(option)) {
                            case 'box_sd_width':
                                tab.find('#uifm_frm_summbox_skin_sdwidth').bootstrapSlider('setValue', parseInt(value));
                                break; 
                        }
                        break;
                     case 'skin_text':
                         switch(String(option)) {
                            case 'text':
                                if( typeof tinymce != "undefined" ) {
                                    var editor = tinymce.get("uifm_frm_summbox_skintxt_txt");
                                    if( editor && editor instanceof tinymce.Editor ) {
                                        var content = decodeURIComponent(value);
                                        editor.setContent( content, {format : 'html'} );
                                    }else{
                                        $('textarea#uifm_frm_summbox_skintxt_txt').val(decodeURIComponent(value));
                                ...
                                break;
                            case 'color':
                                tab.find('#uifm_frm_summbox_skintxt_color').parent().colorpicker('setValue',value);
                                tab.find('#uifm_frm_summbox_skintxt_color').val(value);
                                break;    
                            case 'font':
                                uiformUpdateFontSelect('uifm_frm_summbox_skintxt_font',value);
                                break;
                            case 'font_st':
                                if(parseInt(value)===1){
                                tab.find('#uifm_frm_summbox_skintxt_font_st').prop('checked', true);    
                                }else{
                                tab.find('#uifm_frm_summbox_skintxt_font_st').prop('checked', false);    
                                }
                                break;    
                        }
                        break;
                    ...
                    switch(String(option)) {
                        case 'show_st':
                            if(parseInt(value)===1){
                            tab.find('#uifm_frm_summbox_fmbg_st').bootstrapSwitchZgpb('state', true);
                            }else{
                            tab.find('#uifm_frm_summbox_fmbg_st').bootstrapSwitchZgpb('state', false);    
                            }
                            break;
                        case 'type':
                            switch (parseInt(value)) {
                                    case 2:
                                        tab.find('#uifm_frm_summbox_fmbg_type_2').prop('checked', true);
                                        tab.find('#uifm_frm_summbox_fmbg_type_2').addClass('sfdc-active');
                                        //refresh option
                                        tab.find('#uifm_frm_summbox_fmbg_color_1').closest('.sfdc-row').hide();
                                        tab.find('#uifm_frm_summbox_fmbg_color_2').closest('.sfdc-row').show();
                                        tab.find('#uifm_frm_summbox_fmbg_color_3').closest('.sfdc-row').show();
                                        break;
                                    case 1:
                                    default:
                                        
                                        tab.find('#uifm_frm_summbox_fmbg_type_1').prop('checked', true);
                                        tab.find('#uifm_frm_summbox_fmbg_type_1').addClass('sfdc-active');
                                        //refresh option
                                        tab.find('#uifm_frm_summbox_fmbg_color_1').closest('.sfdc-row').show();
                                        tab.find('#uifm_frm_summbox_fmbg_color_2').closest('.sfdc-row').hide();
                                        tab.find('#uifm_frm_summbox_fmbg_color_3').closest('.sfdc-row').hide();
                                        break;    
                                }
                            break;
                        case 'start_color':
                            tab.find('#uifm_frm_summbox_fmbg_color_2').parent().colorpicker('setValue',value);
                            tab.find('#uifm_frm_summbox_fmbg_color_2').val(value);
                            break;
                        case 'end_color':
                            tab.find('#uifm_frm_summbox_fmbg_color_3').parent().colorpicker('setValue',value);
                            tab.find('#uifm_frm_summbox_fmbg_color_3').val(value);
                            break;
                        case 'solid_color':
                            tab.find('#uifm_frm_summbox_fmbg_color_1').parent().colorpicker('setValue',value);
                            tab.find('#uifm_frm_summbox_fmbg_color_1').val(value);
                            break;
                        case 'image':
                            if(value){
                                $('#uifm_frm_summbox_bg_imgurl').val(value);
                            }
                            break;    
                        }
                        break; 
                    ...
                    switch(String(option)) {
                        case 'show_st':
                            if(parseInt(value)===1){
                            tab.find('#uifm_frm_summbox_fmbora_st').bootstrapSwitchZgpb('state', true);
                            }else{
                            tab.find('#uifm_frm_summbox_fmbora_st').bootstrapSwitchZgpb('state', false);    
                            }
                            break;
                        case 'size':
                            tab.find('#uifm_frm_summbox_fmbora_size').bootstrapSlider('setValue', parseInt(value));
                            break;
                        }
                break;
                case 'form_border':
                    ...
                    switch(String(option)) {
                        case 'show_st':
                            if(parseInt(value)===1){
                            tab.find('#uifm_frm_summbox_fmbor_st').bootstrapSwitchZgpb('state', true);
                            }else{
                            tab.find('#uifm_frm_summbox_fmbor_st').bootstrapSwitchZgpb('state', false);    
                            }
                            break;
                        case 'color':
                            tab.find('#uifm_frm_summbox_fmbor_color').parent().colorpicker('setValue',value);
                            tab.find('#uifm_frm_summbox_fmbor_color').val(value);
                            break;
                        case 'style':
                            switch (parseInt(value)) {
                                    case 2:
                                        tab.find('#uifm_frm_summbox_fmbor_style_2').prop('checked', true);
                                        tab.find('#uifm_frm_summbox_fmbor_style_2').addClass('sfdc-active');
                                        break;
                                    case 1:
                                    default:
                                        tab.find('#uifm_frm_summbox_fmbor_style_1').prop('checked', true);
                                        tab.find('#uifm_frm_summbox_fmbor_style_1').addClass('sfdc-active');
                                        break;    
                                }
                            break;
                        case 'width':
                            tab.find('#uifm_frm_summbox_fmbor_width').bootstrapSlider('setValue', parseInt(value));
                            break;    
                        }
                break;
                case 'form_shadow':
                    ...
                    switch(String(option)) {
                        case 'show_st':
                            if(parseInt(value)===1){
                            tab.find('#uifm_frm_summbox_sha_st').bootstrapSwitchZgpb('state', true);
                            }else{
                            tab.find('#uifm_frm_summbox_sha_st').bootstrapSwitchZgpb('state', false);    
                            }
                            break;
                        case 'color':
                            tab.find('#uifm_frm_summbox_sha_co').parent().colorpicker('setValue',value);
                            tab.find('#uifm_frm_summbox_sha_co').val(value);
                            break;
                        case 'h_shadow':
                           
                            tab.find('#uifm_frm_summbox_sha_x').bootstrapSlider('setValue', parseInt(value));
                            
                            break; 
                        case 'v_shadow':
                            tab.find('#uifm_frm_summbox_sha_y').bootstrapSlider('setValue', parseInt(value));
                            break;
                        case 'blur':
                            tab.find('#uifm_frm_summbox_sha_blur').bootstrapSlider('setValue', parseInt(value));
                            break;    
                        }
                    break;  
                }
             ...
             case 'calculation':
                switch(String(section2)){
                    case 'enable_st':
                        ...
                        if(parseInt(value)===1){
                            $('#uifm_frm_calc_enable').bootstrapSwitchZgpb('state', true);
                            }else{
                            $('#uifm_frm_calc_enable').bootstrapSwitchZgpb('state', false);    
                            }
                        break;
                    case 'variables':
                          zgfm_back_calc.preview_genTabContent();
                    break;
                }
                break;
            case 'skin':
            ...
            case 'input3':
                ...
                switch(String(option)) {
                    case 'text':
                            ...
                            break;
                        case 'size':
                            tab.find('#uifm_fld_inp3_size').selectpicker('val', value);
                            break;
                        case 'bold':
                            if(parseInt(value)===1){
                            tab.find('#uifm_fld_inp3_bold').parent().addClass('sfdc-active');
                            tab.find('#uifm_fld_inp3_bold').val(1);
                            }else{
                            tab.find('#uifm_fld_inp3_bold').parent().removeClass('sfdc-active');
                            tab.find('#uifm_fld_inp3_bold').val(0);
                            }
                            break;
                        case 'italic':
                            if(parseInt(value)===1){
                            tab.find('#uifm_fld_inp3_italic').parent().addClass('sfdc-active');
                            tab.find('#uifm_fld_inp3_italic').val(1);
                            }else{
                            tab.find('#uifm_fld_inp3_italic').parent().removeClass('sfdc-active');    
                            tab.find('#uifm_fld_inp3_italic').val(0);
                            }
                            break;
                        case 'underline':
                            if(parseInt(value)===1){
                            tab.find('#uifm_fld_inp3_u').parent().addClass('sfdc-active');
                            tab.find('#uifm_fld_inp3_u').val(1);
                            }else{
                            tab.find('#uifm_fld_inp3_u').parent().removeClass('sfdc-active');
                            tab.find('#uifm_fld_inp3_u').val(0);
                            }
                            break;
                       
                        case 'color':
                            tab.find('#uifm_fld_inp3_color').parent().colorpicker('setValue',value);
                            tab.find('#uifm_fld_inp3_color').val(value);
                            break;
                        case 'font':
                            //if(value){
                            //tab.find('#uifm_fld_lbl_font').val('Marcellus SC')
                              uiformUpdateFontSelect('uifm_fld_inp3_font',value);
                           // }
                            break;
                        case 'font_st':
                            if(parseInt(value)===1){
                            tab.find('#uifm_fld_inp3_font_st').prop('checked', true);    
                            }else{
                            tab.find('#uifm_fld_inp3_font_st').prop('checked', false);    
                            }
                            break;
                        case 'val_align':
                            switch (parseInt(value)) {
                                    case 1:
                                        tab.find('#uifm_fld_inp3_align_2').prop('checked', true);
                                        tab.find('#uifm_fld_inp3_align_2').parent().addClass('sfdc-active');
                                        break;
                                    case 2:
                                        tab.find('#uifm_fld_inp3_align_3').prop('checked', true);
                                        tab.find('#uifm_fld_inp3_align_3').parent().addClass('sfdc-active');
                                        break;
                                    case 0:
                                    default:
                                    
                                        tab.find('#uifm_fld_inp3_align_1').prop('checked', true);
                                        tab.find('#uifm_fld_inp3_align_1').parent().addClass('sfdc-active');
                                        break;    
                                }
                            break;    
                        default:
              ...
              case 'txt_block':
                ...
                case 'price':
                    switch(String(option)) {
                        case 'enable_st':
                            if(parseInt(value)===1){
                            tab.find('#uifm_fld_price_enable_st').bootstrapSwitchZgpb('state', true);
                            }else{
                            tab.find('#uifm_fld_price_enable_st').bootstrapSwitchZgpb('state', false);    
                            }
                            break;
                        case 'lbl_show_st':
                            if(parseInt(value)===1){
                            tab.find('#uifm_frm_price_lbl_show_st').bootstrapSwitchZgpb('state', true);
                            }else{
                            tab.find('#uifm_frm_price_lbl_show_st').bootstrapSwitchZgpb('state', false);    
                            }
                            break;
                        case 'lbl_show_format':
                            if( typeof tinymce != "undefined" ) {
                                
                                var editor = tinymce.get("uifm_fld_price_lbl_format");
                                if( editor && editor instanceof tinymce.Editor ) {
                                    var content = decodeURIComponent(value);
                                    editor.setContent( content, {format : 'html'} );
                                }else{
                                    $('textarea#uifm_fld_price_lbl_format').val(decodeURIComponent(value));
                        ...
                        case 'color':
                            tab.find('#uifm_fld_price_lbl_color').parent().colorpicker('setValue',value);
                            tab.find('#uifm_fld_price_lbl_color').val(value);
                            break;
                        case 'font':
                            uiformUpdateFontSelect('uifm_fld_price_lbl_font',value);
                            break;
                        case 'font_st':
                            if(parseInt(value)===1){
                            tab.find('#uifm_fld_price_lbl_font_st').prop('checked', true);    
                            }else{
                            tab.find('#uifm_fld_price_lbl_font_st').prop('checked', false);    
                            }
                            break;
                        case 'unit_price':
                            tab.find('#uifm_fld_price_unitprice').val(parseFloat(value));
                            break;     
                        }
                break;
                case 'help_block':
   ...
   arguments.callee.loadFormToEditPanel_default = function () {
           
           //invoice

        //on submission tab
        if(typeof mainrformb['invoice'] == 'undefined') {
            mainrformb['invoice']={};
            this.setUiData('invoice',form_data.data.fmb_data['invoice']);
           ...
           //main tab
           if(typeof mainrformb['calculation'] == 'undefined') {
            this.setUiData('calculation',form_data.data.fmb_data['calculation']);
           }
         var tab;
        ...
        rocketform.wizardtab_refreshPreview();
         ...
         /*load summary box*/
        var form_tab_summbox=this.getUiData('summbox');
        var tab_summb=$('#uiform-settings-tab3-4');
        $.each(form_tab_summbox, function(i, value) {
            if($.isPlainObject(value)){
                $.each(value, function(i2, value2) {
                    rocketform.setDataOptToSetFormTab(tab_summb,'summbox',i+'-'+i2,value2);
                });
            }else{
                rocketform.setDataOptToSetFormTab(tab_summb,'summbox',i+'-'+'',value);
            }
        });
        rocketform.previewform_refreshsummbox();
        rocketform.previewsummbox_shadowBox();
        rocketform.previewform_summboxBackground();
        rocketform.previewsummbox_elementBorderRadius();
        rocketform.previewsummbox_elementBorder();
        /*end load summary box*/
        ...
        /*temp solution when summary box is enabled*/
        var tmp_sm_enable_st = this.getUiData3('summbox','setting','enable_st');
        if(parseInt(tmp_sm_enable_st)===1){
            this.setUiData3('summbox','setting','enable_st',0);
            rocketform.previewform_refreshsummbox();
            this.setUiData3('summbox','setting','enable_st',1);
            rocketform.previewform_refreshsummbox();
        }
    ...
    arguments.callee.loadFormToEditPanel = function (form_data) {
        try {
            ...
            var mainrformb_tmp = {
                        app_ver:form_data.data.fmb_data['app_ver'],
                        main:form_data.data.fmb_data['main'],
                        invoice:form_data.data.fmb_data['invoice'],
                        calculation:form_data.data.fmb_data['calculation'],
                        summbox:form_data.data.fmb_data['summbox'],
        ...
        $.each(mainrformb['steps_src'], function(index, value) {
         ...
         if(typeof mainrformb['onsubm'] == 'undefined') {
            ...
            /* calculation tab*/
            if(typeof mainrformb['calculation'] == 'undefined') {
                mainrformb['calculation']={};
                this.setUiData('calculation',form_data.data.fmb_data['calculation']);
            }  
            
          rocketform.loadFormToEditPanel_default();      
    ...
    arguments.callee.getFieldsAfterDraggable = function (element,field_type,isClicked,id_doubled) {
            ...
            this.previewfield_hideAllPopOver();
              ...
              switch (parseInt(field_type)) {
                     ...
                     /*add new value*/
                    rocketform.formvariables_addTolist(id);
  ...
  arguments.callee.formsetting_setFieldName_check = function () {
    ...
    arguments.callee.saveTabContent = function () {
      ...
      // this.setUiData2('steps','tab_title',tab_titles);
       ...
       var main_priceest=($('#uifm_frm_main_pricest').bootstrapSwitchZgpb('state'))?1:0;
       this.setUiData2('main','price_st',main_priceest);
       var main_paymentst=($('#uifm_frm_main_paymentst').bootstrapSwitchZgpb('state'))?1:0;
       this.setUiData2('main','payment_st',main_paymentst);
       var main_currency=$('#uifm_frm_main_price_currency').val();
       var main_currency_symbol=$('#uifm_frm_main_price_currency_symbol').val();
       var main_cur_format_st=($('#uifm_frm_main_price_format_st').bootstrapSwitchZgpb('state'))?1:0;
       var main_cur_decimal=$('#uifm_frm_main_price_decimal').val();
       var main_cur_thousand=$('#uifm_frm_main_price_thousand').val();
       var main_cur_precision=$('#uifm_frm_main_price_precision').val();
       //tax
       var main_currency_tax_st=$('#uifm_frm_main_price_tax_st').bootstrapSwitchZgpb('state')?1:0;
       var main_currency_tax_val=$('#uifm_frm_main_price_tax_val').val();
       
     
       this.setUiData2('main','price_currency',main_currency);
       this.setUiData2('main','price_currency_symbol',main_currency_symbol);
       this.setUiData2('main','price_format_st',main_cur_format_st);
       this.setUiData2('main','price_sep_decimal',main_cur_decimal);
       this.setUiData2('main','price_sep_thousand',main_cur_thousand);
       this.setUiData2('main','price_sep_precision',main_cur_precision);
       this.setUiData2('main','price_tax_st',main_currency_tax_st);
       this.setUiData2('main','price_tax_val',main_currency_tax_val);
       ...
       //invoice
       var inv_from_text1=$('#uifm_frm_inv_from_text1').val();
       var inv_from_text2=$('#uifm_frm_inv_from_text2').val();
       var inv_from_text3=$('#uifm_frm_inv_from_text3').val();
       var inv_from_text4=$('#uifm_frm_inv_from_text4').val();
       var inv_from_text5=$('#uifm_frm_inv_from_text5').val();
       
       var inv_to_text1=$('#uifm_frm_inv_to_text1').val();
       var inv_to_text2=$('#uifm_frm_inv_to_text2').val();
       var inv_to_text3=$('#uifm_frm_inv_to_text3').val();
       var inv_to_text4=$('#uifm_frm_inv_to_text4').val();
       var inv_to_text5=$('#uifm_frm_inv_to_text5').val();
       this.setUiData2('invoice','from_text1',encodeURIComponent(inv_from_text1));
       this.setUiData2('invoice','from_text2',encodeURIComponent(inv_from_text2));
       this.setUiData2('invoice','from_text3',encodeURIComponent(inv_from_text3));
       this.setUiData2('invoice','from_text4',encodeURIComponent(inv_from_text4));
       this.setUiData2('invoice','from_text5',encodeURIComponent(inv_from_text5));
       this.setUiData2('invoice','to_text1',encodeURIComponent(inv_to_text1));
       this.setUiData2('invoice','to_text2',encodeURIComponent(inv_to_text2));
       this.setUiData2('invoice','to_text3',encodeURIComponent(inv_to_text3));
       this.setUiData2('invoice','to_text4',encodeURIComponent(inv_to_text4));
       this.setUiData2('invoice','to_text5',encodeURIComponent(inv_to_text5));
       
       //calculation
       zgfm_back_calc.saveform_processVariables();
       ...
       this.setUiData2('wizard','tabs',tmpTabs);
       //store to ..
    ...
    arguments.callee.invoice_delreg = function (pgr_id) {
        rocketform.showLoader(4,true,true);
        
                $.ajax({
                    type: 'POST',
                    url: rockfm_vars.uifm_siteurl+"gateways/records/ajax_delete_records",
                    data: {
                       'action': 'rocket_fbuilder_invoice_delete_records',
                       'page':'zgfm_cost_estimate',
                       'zgfm_security':uiform_vars.ajax_nonce,
                       'pgr_id':pgr_id,
                            'csrf_field_name':uiform_vars.csrf_field_name
                    ...
                    success: function(msg) {
                        ...
                        $("#uiform-container a[data-pgrid='" + pgr_id + "']").closest('tr').fadeOut( "slow" );
   ...
   arguments.callee.importForm_onfailPopup = function () {
       ...
       $('#uifm_form_import_onfail .modal-title').html($('#uifm_frm_preview_import_title').val());
   ...
   arguments.callee.genpdf_inforecord = function (rec_id) {
       ...
       $("body").append("<iframe src='" + uiform_vars.url_admin+ "/formbuilder/frontend/pdf_show_record/?uifm_mode=pdf&id="+rec_id+"' style='display: none;' ></iframe>");
        ...
        var tmpSend = new uifm_iframeform(uiform_vars.url_site+'?uifm_costestimator_api_handler&action=uifm_est_api_handler&uifm_action=show_record&uifm_mode=pdf&id='+rec_id);
            tmpSend.send(); 
   ...
   arguments.callee.genpdf_infoinvoice = function (rec_id) {
       try{
       $("body").append("<iframe src='" + uiform_vars.url_admin+ "formbuilder/frontend/pdf_show_invoice/?uifm_mode=pdf&id="+rec_id+"' style='display: none;' ></iframe>");
        ...
        var tmpSend = new uifm_iframeform(uiform_vars.url_site+'?uifm_costestimator_api_handler&action=uifm_est_api_handler&uifm_action=show_invoice&uifm_mode=pdf&id='+rec_id);
            tmpSend.send(); 
   ...
   arguments.callee.customReport_loadFieldbyForm = function () {
    ...
    arguments.callee.saveForm_showModalSuccess = function (idval) {
         ...
         $.ajax({
                        ...
                        data: {
                        'action': 'rocket_fbuilder_form_showmodalsuccess',
                        'page':'zgfm_cost_estimate',
                        'zgfm_security':uiform_vars.ajax_nonce,
                        'form_id':idval,
                            'csrf_field_name':uiform_vars.csrf_field_name
    ...
    arguments.callee.saveForm = function () {
       ...
       if( typeof tinymce != "undefined" ) {
                        ...
                        if( editor && editor instanceof tinymce.Editor ) {
                            uifm_frm_inv_tpl_html = tinymce.get("uifm_frm_invoice_tpl_content").getContent();
                        }else{
                            uifm_frm_inv_tpl_html = ($('#uifm_frm_invoice_tpl_content').val())?$('#uifm_frm_invoice_tpl_content').val():'';
                        }
                    } 
   //record template
   var uifm_frm_rec_tpl_html;             
       var uifm_frm_inv_tpl_st=($('#uifm_frm_record_tpl_enable').bootstrapSwitchZgpb('state'))?1:0;
       if( typeof tinymce != "undefined" ) {
                ...
                $.ajax({
                    ...
                    data: {
                       ...
                       'uifm_frm_inv_tpl_st':uifm_frm_inv_tpl_st,
                       'uifm_frm_inv_tpl_html':encodeURIComponent(uifm_frm_inv_tpl_html),
                       'uifm_frm_rec_tpl_st':uifm_frm_inv_tpl_st,
      ...
      arguments.callee.loadForm_tab_subm = function () {       
       ...
       arguments.callee.wizardtab_changeTabTitle = function (nro) {
                ...
                //update to main data 
                rocketform.setUiData4('wizard','tabs',nro,'title',tab_title);
       ...
       arguments.callee.wizardtab_addNewTab = function () {
               ...
               rocketform.addIndexUiData2('wizard','tabs',parseInt(newNum));
               rocketform.setUiData3('wizard','tabs',parseInt(newNum),{title:'Tab title '+(newNum)});
      ...
      arguments.callee.wizardtab_deleteTab = function (element) {
          ...
          if(parseInt(el_num)!=0){
            ...
            //delete main data
            rocketform.delUiData3('wizard','tabs',parseInt(el_num));
            var tmp_arr=mainrformb['wizard']['tabs'];
                    var tmp_len = tmp_arr.length, tmp_i;
                    for(tmp_i = 0; tmp_i < tmp_len; tmp_i++ )
                            tmp_arr[tmp_i] && tmp_arr.push(tmp_arr[tmp_i]);
                    if($.isArray(tmp_arr)){
                        tmp_arr.splice(0 ,tmp_len);
                        mainrformb['wizard']['tabs']=tmp_arr;
                    }
      ...
      arguments.callee.wizardtab_changeThemeOnPreview = function () {
         ...
         var elm_li=this.getUiData2('wizard','tabs');
         var string_html='';
         var count=0;
            switch(wiz_theme_typ)
            {
           ...
           //enable status
            ...
            $('#uifm_frm_wiz_st').bootstrapSwitchZgpb('state',wiz_bg_st);
             //painting tabs
                ...
                var wiz_tab_list=this.getUiData2('wizard','tabs');
       ...
       arguments.callee.wizardtab_tabManageEvt = function () {
        ...
        arguments.callee.fieldsetting_deleteFieldDialog = function () {
            ...
            btn2_title=$('#uifm_fld_del_box_bt2_title').val();
             ...
             arguments.callee.listform_duplicate = function () {
                 if($('.uiform-listform-chk-id').is(":checked")){
                     ...
                     $.ajax({
                            ...
                            data:data+'&action=rocket_fbuilder_listform_duplicate&page=zgfm_cost_estimate&csrf_field_name='+uiform_vars.csrf_field_name,
                            success: function(msg) {
             ...
             arguments.callee.listform_updateStatus = function (form_st) {
                 ...
                 if($('.uiform-listform-chk-id').is(":checked")){
                     ...
                     $.ajax({
                            ...
                            data:data+'&action=rocket_fbuilder_listform_updatest&page=zgfm_cost_estimate&form_st='+form_st+'&csrf_field_name='+uiform_vars.csrf_field_name,
                            success: function(msg) {
                                rocketform.redirect_tourl(uiform_vars.url_admin+'formbuilder/forms/list_uiforms');
                            }
                        });
             ...
             arguments.callee.input2settings_priceOption = function (element) {
                  var el=$(element);
                 var optnro = el.closest('.uifm-fld-inp2-options-row').data('opt-index');
                 var f_id= $('#uifm-field-selected-id').val();
                 var opt_value=$('#uifm_frm_inp2_opt'+optnro+'_price').val();
                 var f_step=$('#'+f_id).closest('.uiform-step-pane').data('uifm-step');
                 
                 rocketform.setUiData7('steps_src',parseInt(f_step),f_id,'input2','options',optnro,'price',opt_value);
             ...
             arguments.callee.input2settings_valueOption = function (element) {
                 ...
                 var optnro = el.closest('.uifm-fld-inp2-options-row').data('opt-index');
                 var f_id= $('#uifm-field-selected-id').val();
                 var opt_value=$('#uifm_frm_inp2_opt'+optnro+'_value').val();
                 var f_step=$('#'+f_id).closest('.uiform-step-pane').data('uifm-step');
             ...
             arguments.callee.input2settings_addNewRdoOption=function (){
                ...
                switch(parseInt(f_type)){
                 ...
                 /*price*/
                 newopt.find('.uifm_frm_inp2_opt_price_evt').attr('id','uifm_frm_inp2_opt'+optindex+'_price');
                 newopt.find('.uifm_frm_inp2_opt_price_evt').val('0');
                ...
                var f_balign;
                 ...
                 //set to main data
                // rocketform.addIndexUiData5('steps_src',parseInt(f_step),f_id,'input2','options',parseInt(optindex));
                // rocketform.setUiData6('steps_src',parseInt(f_step),f_id,'input2','options',parseInt(optindex),{label:'Option',checked:0,price:0});
             };
             
             arguments.callee.pricesettings_labelformat=function (field_obj){
                var f_id=field_obj.attr('id');
                 var f_step=$('#'+f_id).closest('.uiform-step-pane').data('uifm-step');
                 var f_enable_st=this.getUiData5('steps_src',f_step,f_id,'price','enable_st');
                 var f_lbl_show_st=this.getUiData5('steps_src',f_step,f_id,'price','lbl_show_st');
                 
                 var tmp_str;
                 tmp_str='';
                 if(parseInt(f_lbl_show_st)===1 && parseInt(f_lbl_show_st)===1 ){
                     var f_lbl_show_format=this.getUiData5('steps_src',f_step,f_id,'price','lbl_show_format');
                     var f_lbl_show_color=this.getUiData5('steps_src',f_step,f_id,'price','color');
                     
                    f_lbl_show_format=decodeURIComponent(f_lbl_show_format);
                    f_lbl_show_format=rocketform.pricesettings_processFormats(f_lbl_show_format);
                    
                    /*set skin*/
                   var tmp_obj_lbl=$('#'+f_id).find('.uifm_frm_price_lbl_cont');
                     tmp_obj_lbl.css({
                            'color': f_lbl_show_color
                        });
                    rocketform.previewfield_fontfamily($('#'+f_id),'price',tmp_obj_lbl);
                    
                    tmp_str+=f_lbl_show_format
                 }
                 ...
                 switch(parseInt(f_type)){
                     case 8:
                         ...
                         $.each(options, function(index, value) {
                            ...
                            /*price*/
                            newopt.find('.uifm_frm_inp2_opt_price_evt').attr('id','uifm_frm_inp2_opt'+index+'_price');
                            newopt.find('.uifm_frm_inp2_opt_price_evt').val(value['price']);
             ...
             arguments.callee.globalsettings_saveOptions=function (){      
                   ...
                   var data=$('#uifrm-setting-form').serialize();
                     $.ajax({
                            ...
                            data:data+'&action=rocket_fbuilder_setting_saveOpts&page=zgfm_cost_estimate&csrf_field_name='+uiform_vars.csrf_field_name,
                            success: function(msg) {
rocketform.hideLoader();
...
arguments.callee.wizardform_refresh = function(){
       ...
       $('#uifm_modal_msg .sfdc-modal-body').html('<p>'+$('#uifm_guidetour_popup_notfound').val()+'</p>');
             ...
             arguments.callee.previewform_refreshsummbox=function (){
               var elbox=$('#uifm-sticky-sidebar-box');
                var sm_enable_st=this.getUiData3('summbox','setting','enable_st'),
                    sm_res_pos=this.getUiData3('summbox','setting','resp_pos'),
                    sm_box_sd_width=this.getUiData3('summbox','skin_box','box_sd_width'),
                    sm_pos=this.getUiData3('summbox','setting','pos'),
                    sm_skt_text=this.getUiData3('summbox','skin_text','text'),
                    sm_skt_color=this.getUiData3('summbox','skin_text','color'),
                    sm_skt_font=this.getUiData3('summbox','skin_text','font'),
                    sm_skt_font_st=this.getUiData3('summbox','skin_text','font_st');
                
                
                if(parseInt(sm_enable_st)===1){
                    elbox.show();
                    
                     var sm_pos_lbl;
                        switch(parseInt(sm_pos)){
                        case 1:
                                sm_pos_lbl='right';
                                break;
                        case 2:
                    ...
                    if (elbox.data('uiform_stickybox')){
                        
                        elbox.data('uiform_stickybox').updateData({
                                enable:0,
                        ...
                        elbox.data('uiform_stickybox').init();
                    }else{
                        
                        elbox.uiform_stickybox({
                                enable:0,
                                orientation:sm_pos_lbl,
                                form_container: $('.uiform-main-form'),
                                main_container:$('.uiform-preview-base'),
                    ...
                    /*add-update content*/
                    var tmp_sticky_txt=decodeURIComponent(sm_skt_text);
                    
                    tmp_sticky_txt=rocketform.pricesettings_processFormats(tmp_sticky_txt);
                    
                    /*tmp_sticky_txt = tmp_sticky_txt.replace("/[ui_symbol]/g", "$");
                    tmp_sticky_txt = tmp_sticky_txt.replace("/[ui_total]/g", "##");
                    tmp_sticky_txt = tmp_sticky_txt.replace("/[ui_currency]/g", "USD");*/
                    $('#uifm-sticky-sidebar-box-content').html(tmp_sticky_txt);
                    $('#uifm-sticky-sidebar-box-content').css({
                            'color': sm_skt_color
                        });
                    if(parseInt(sm_skt_font_st)===1 && sm_skt_font){
                        var font_sel = JSON.parse(sm_skt_font);
                        $('#uifm-sticky-sidebar-box-content').css('font-family',font_sel.family);
                    }else{
                        $('#uifm-sticky-sidebar-box-content').removeCss('font-family');
                    }
                    
                    
                }else{
                    elbox.hide();
                    $('.uiform-main-form').removeCss('width');
                    //refresh if it has width skin configured
                    rocketform.previewform_skin_maxwidth();
                }
                
                 
                /* recalc message on preview*/
                rocketform.guidedtour_showTextOnPreviewPane_recalc(); 
             };
             
             arguments.callee.pricesettings_processFormats=function (str){
                 var tmp_mapObj = {'\\[uifm_symbol]':'$',
                     '\\[uifm_total]':'##',
                     '\\[uifm_price]':'##',
                     '\\[uifm_summary (.+?)]':' here goes summary content',
                     '\\[uifm_summary_link (.+?)]':'<a class="uifm-stickybox-summary-link" href="javascript:void(0);">Show summary </a>',
                     '\\[uifm_currency]':'USD'};
                    
                    str=rocketform.strings_replace_all(str,tmp_mapObj);
                    return str;
             };
             
             arguments.callee.strings_replace_all=function (str, mapObj){
            ...
            arguments.callee.testing_summbox=function (){
                console.log('data.formc_obj_width : '+$('.uiform-preview-base').outerWidth(true));
             };
            ...
            $.ajax({
             ...
             arguments.callee.regenerateform=function (){
                 /*load loader*/
                 rocketform.loading_panelbox2(1);
        ...
        /*problem on form data variable when sending data, fixed putting on last */
             ...
             arguments.callee.gateway_saveoffline=function (){
                      // validation
                    $('#uiform-form-editgateway').validate({
                        ...
                        submitHandler: function(form) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: rockfm_vars.uifm_siteurl+'gateways/settings/ajax_save_options',
                                data:data+'&action=rocket_fbuilder_setting_saveGateway&page=zgfm_cost_estimate'+'&csrf_field_name='+uiform_vars.csrf_field_name,
                                beforeSend: function() {
                                                      /*show modal success*/
                                   rocketform.showLoader(3,true,true);
                                                    },
                        ...
                        $("#uiform-form-editgateway").submit();
             };
             
             arguments.callee.gateway_savepaypal=function (){
                      // validation
                    $('#uiform-form-editgateway').validate({
                        errorClass: "help-inline",
                        errorElement: "span",
             ...
             arguments.callee.gateway_gotoList=function (){
                 var re_url= rockfm_vars.uifm_siteurl+'gateways/settings/view_settings';
                 rocketform.redirect_tourl(re_url);
             };
             ...
             arguments.callee.formvariables_generateTable=function (){
                  var temp=this.getInnerVariable('form_rec_vars');
                
                $('#uiform-form-mailset-vars-tab-1 .uifm-tab-inner-vars-1 table').find('tbody').html('');
                
                var row_str='';
                var tmp_f_type='';
                $.each(temp, function(index, value) {
                    tmp_f_type=parseInt(rocketform.formvariables_findFieldType(value));
                    switch(tmp_f_type){
                                            case 6:case 7:case 12:case 13:case 15:
                                            case 22:case 23:case 24:case 25:case 26:case 28:case 29:case 30:case 43:
                                            row_str+='<tr>';
                                            row_str+='<td>'+rocketform.formvariables_findFieldName(value)+'</td>';
                                            row_str+='<td><textarea class="uifm_txtarea_var" onclick="this.select();">[uifm_recvar id="'+value+'" atr1="label"]</textarea></td>';
                                            row_str+='<td><textarea class="uifm_txtarea_var" onclick="this.select();">[uifm_recvar id="'+value+'" atr1="input"]</textarea></td>';
                                            row_str+='<td></td>';
                                            row_str+='<td></td>';
                                            row_str+='<td><textarea class="uifm_txtarea_var" onclick="this.select();">[uifm_wrap id="'+value+'"]here goes your content if field have some value. if no value, this will not appear.[/uifm_wrap]</textarea></td>';
                                            row_str+='</tr>';  
                                            break;
                                            case 8:case 9:case 10:case 11:case 40:
                                            row_str+='<tr>';
                                            row_str+='<td>'+rocketform.formvariables_findFieldName(value)+'</td>';
                                            row_str+='<td><textarea class="uifm_txtarea_var" onclick="this.select();">[uifm_recvar id="'+value+'" atr1="label" ]</textarea></td>';
                                            row_str+='<td><textarea class="uifm_txtarea_var" onclick="this.select();">[uifm_recvar id="'+value+'" atr1="value" ]</textarea></td>';
                                            row_str+='<td><textarea class="uifm_txtarea_var" onclick="this.select();">[uifm_recvar id="'+value+'" atr1="amount" ]</textarea></td>';
                                            row_str+='<td></td>';
                                            row_str+='<td><textarea class="uifm_txtarea_var" onclick="this.select();">[uifm_wrap id="'+value+'"]here goes your content if field have some value. if no value, this will not appear.[/uifm_wrap]</textarea></td>';
                                            row_str+='</tr>';
                                            break;
                                            ...
                                            row_str+='<td>'+rocketform.formvariables_findFieldName(value)+'</td>';
                                            row_str+='<td><textarea class="uifm_txtarea_var" onclick="this.select();">[uifm_recvar id="'+value+'" atr1="label" ]</textarea></td>';
                                            row_str+='<td><textarea class="uifm_txtarea_var" onclick="this.select();">[uifm_recvar id="'+value+'" atr1="input" atr2="value" ]</textarea></td>';
                                            row_str+='<td><textarea class="uifm_txtarea_var" onclick="this.select();">[uifm_recvar id="'+value+'" atr1="input" atr2="amount" ]</textarea></td>';
                                            row_str+='<td></td>';
                                            row_str+='<td><textarea class="uifm_txtarea_var" onclick="this.select();">[uifm_wrap id="'+value+'"]here goes your content if field have some value. if no value, this will not appear.[/uifm_wrap]</textarea></td>';
                                            row_str+='</tr>';
                                            break;
                                            ...
                                            row_str+='<td><textarea class="uifm_txtarea_var" onclick="this.select();">[uifm_recvar id="'+value+'" atr1="input" ]</textarea></td>';
                                            row_str+='<td><textarea class="uifm_txtarea_var" onclick="this.select();">[uifm_recvar id="'+value+'" atr1="amount" ]</textarea></td>';
                                            row_str+='<td><textarea class="uifm_txtarea_var" onclick="this.select();">[uifm_recvar id="'+value+'" atr1="qty" ]</textarea></td>';
                                            row_str+='<td><textarea class="uifm_txtarea_var" onclick="this.select();">[uifm_wrap id="'+value+'"]here goes your content if field have some value. if no value, this will not appear.[/uifm_wrap]</textarea></td>';
                                            row_str+='</tr>';
                ...
                $('#uiform-form-mailset-vars-tab-1 .uifm-tab-inner-vars-1 table').find('tbody').append(row_str); 
             };
             ...
             arguments.callee.invoiceoptions_genListToIntMem=function (){
                
                 rocketform.setInnerVariable('form_vars_invoice_optto',[]);
                 /*clean main data*/  
                        if(parseInt($.map(mainrformb['steps_src'], function(n, i) { return i; }).length)!=0){
                            $.each(mainrformb['steps_src'], function(index3, value3) {
                              $.each(value3, function(index4, value4) {
                                    if(parseInt($('#'+index4).length)!=0){
                                       switch(parseInt(value4['type'])){
                                            case 6:case 7:case 28:case 29:case 30:
                                                  rocketform.invoiceoptions_addTolist(value4['id']);
                                            break;
                                        } 
                                    } 
                                }); 
                 ...
                 rocketform.invoiceoptions_generateHtml();        
             };
             arguments.callee.invoiceoptions_addTolist=function (value){
                /*if(!rocketform.getInnerVariable('form_vars_invoice_optto')){
                   rocketform.setInnerVariable('form_vars_invoice_optto',[]);  
                 } */
                
                var temp;
                temp=this.getInnerVariable('form_vars_invoice_optto');
                if ($.inArray(value,temp)==-1) temp.push(value);
                this.setInnerVariable('form_vars_invoice_optto',temp);
               
             };
             arguments.callee.invoiceoptions_generateHtml=function (){
                
                var tmp_count = [1,2,3,4];
                var tmp_var;
                var tmp_value;
                $.each(tmp_count, function(index, value) {
                     $('#uifm_frm_inv_to_text'+value).html('');
                     $('#uifm_frm_inv_to_text'+value).append('<option value="">'+$('#uifm_frm_inv_to_text'+value).attr('data-uifm-firstoption')+'</option>');
                     
                     tmp_var=rocketform.getInnerVariable('form_vars_invoice_optto');
                     $.each(tmp_var, function(index2, value2) {
                        $('#uifm_frm_inv_to_text'+value).append('<option value="'+value2+'">'+rocketform.formvariables_findFieldName(value2)+'</option>'); 
                     });
                     
                     //assign value
                    tmp_value = rocketform.getUiData2('invoice','to_text'+value);
                   
                   
                    if(parseInt($("#uifm_frm_inv_to_text"+value+" option[value='"+tmp_value+"']").length) > 0){
                        $('#uifm_frm_inv_to_text'+value).val(tmp_value);
                    }else{
                        $('#uifm_frm_inv_to_text'+value).val("");
                        rocketform.setUiData2('invoice','to_text'+value,"");
                    }
      ...
      arguments.callee.tinymceEvent_init =function(){
          ...
          return;
                             var wpTxtContainer
                               ...
                               /*price*/
                               if($('#uiform-build-field-tab').find('#uifm_fld_price_lbl_format')){
                                    wpTxtContainer="uifm_fld_price_lbl_format";
   ...
   arguments.callee.checkIntegrityTinyMCE = function (type) {
    ...
    arguments.callee.fields_events_bswitch = function (tab) {
        try{
            ...
            /*preview fields*/
            $('#zgpb-editor-container .uifm-inp15-fld').bootstrapSwitchZgpb();
