$uifm(document).ready(function ($) {
   ...
   $('input,textarea').attr('autocomplete', 'off');
    ...
    /* tinymce text*/
    var uifm_obj_txtarea_editors = [$('#uifm_fld_msc_text'),
                             $('#uifm_fld_inp3_html'),
                             $('#uifm_fld_price_lbl_format'),
                             $('#uifm_frm_summbox_skintxt_txt'),
                             $('#uifm_frm_inp18_txt_cont')
                            ];
    ...
    /*summbox tab - status*/
    $(document).on( "change", "#uiform-settings-tab3-4 .uifm-f-setoption-st", function(e) {
    ...
    $(document).on( "click", ".uifm-fmskin-setoption-btn", function(e) {
      ...
      /*form summary box*/
    $(document).on( "click", ".uifm-fmsummbox-setoption-btn", function(e) {
        var store=$( this ).data('form-store');
        var f_store=store.split("-");
        var f_sec=f_store[0];
        var f_opt=f_store[1];
        ...
        rocketform.setUiData3('summbox',f_sec,f_opt,f_val);
         var obj_field= $('#uifm-sticky-sidebar-box');
         if(obj_field){
    ...
    /*summbox tab*/
    $('#uiform-settings-tab3-4').find('.uifm-custom-color').colorpicker().on('changeColor', function(ev){
   ...
   $('.uifm_frm_skin_bgst_event').on('switchChange.bootstrapSwitchZgpb', function(event, state) {
    ...
    /* summbox tab - select option*/
     
    $('.uifm_tabsb_selecpicker_wrap select').on('changed.bs.select', function (e) {
      ...
      var obj_option=$(this);
            ...
            var store=obj_option.data('form-store');
            var main_sec=obj_option.data('form-msec');
            var f_store=store.split("-");
                var f_sec=f_store[0];
                var f_opt=f_store[1];
           var f_val=selectedValue;
    ...
    $('#uifm_frm_skin_fmbg_type_1').on('click', function () {
        $('#uifm_frm_skin_fmbg_color_1').closest('.sfdc-row').show();
        $('#uifm_frm_skin_fmbg_color_2').closest('.sfdc-row').hide();
        $('#uifm_frm_skin_fmbg_color_3').closest('.sfdc-row').hide();
    });
    $('#uifm_frm_skin_fmbg_type_2').on('click', function () {
        $('#uifm_frm_skin_fmbg_color_1').closest('.sfdc-row').hide();
        $('#uifm_frm_skin_fmbg_color_2').closest('.sfdc-row').show();
        $('#uifm_frm_skin_fmbg_color_3').closest('.sfdc-row').show();
    });
    
    /*action for input18 - form skin*/
    $('#uifm_frm_inp18_fmbg_type_1').on('click', function () {
        $('#uifm_frm_inp18_fmbg_color_1').closest('.sfdc-row').show();
        $('#uifm_frm_inp18_fmbg_color_2').closest('.sfdc-row').hide();
        $('#uifm_frm_inp18_fmbg_color_3').closest('.sfdc-row').hide();
    });
    $('#uifm_frm_inp18_fmbg_type_2').on('click', function () {
        $('#uifm_frm_inp18_fmbg_color_1').closest('.sfdc-row').hide();
        $('#uifm_frm_inp18_fmbg_color_2').closest('.sfdc-row').show();
        $('#uifm_frm_inp18_fmbg_color_3').closest('.sfdc-row').show();
    });
    
    
     /*action for background color summbox - form skin*/
    $('#uifm_frm_summbox_fmbg_type_1').on('click', function () {
        $('#uifm_frm_summbox_fmbg_color_1').closest('.sfdc-row').show();
        $('#uifm_frm_summbox_fmbg_color_2').closest('.sfdc-row').hide();
        $('#uifm_frm_summbox_fmbg_color_3').closest('.sfdc-row').hide();
    });
    $('#uifm_frm_summbox_fmbg_type_2').on('click', function () {
        $('#uifm_frm_summbox_fmbg_color_1').closest('.sfdc-row').hide();
        $('#uifm_frm_summbox_fmbg_color_2').closest('.sfdc-row').show();
        $('#uifm_frm_summbox_fmbg_color_3').closest('.sfdc-row').show();
    });
    
    $('#uifm_fld_val_reqicon_img').on('change', function(e) { 
        var f_id= $('#uifm-field-selected-id').val();
        var store=$( this ).data('field-store');
        var f_store=store.split("-");
        var f_sec=f_store[0];
	...
	$('#uifm_frm_skin_bg_btnadd').click(function() {
      ...
      /*when changing tabs*/  
       ...
       /*calc tab*/
       $('.uiform-wrap .uiform-settings-calc').on('shown.bs.sfdc-tab', function (e) {
          
         let tmp_var = $('#zgfm-tab-calc-sourcecode-wrapper .tabs-left').find('li.sfdc-active a').attr('data-zgfm-id');
          
          var cminst = $('#uifm_frm_calc_content'+tmp_var).data('CodeMirrorInstance');  
            if(cminst){
                cminst.refresh();
            }  
       ...
       //refresh inner calc tabs
       zgfm_back_calc.calc_refreshEvents();
  ...
  return this.each(function() {
    ...
    if (styles.length === 0) {
     ...
     rocketform.initPanel();
        ...
        /*summbox tab*/
        $('#uiform-settings-tab3-4 select.sfm').change( function(){
