...
if(e) { e.stopPropagation(); e.preventDefault();}
            ...
            this.refresh_quickopt_position = function(){
                      ...
                      this.enableSettingOptions= function(f_data,addt) {
                                    ...
                                    case 10:
                                        ...
                                        obj.find('.uifm-input2-wrap').append('<select class="sfdc-form-control uifm-input2-opt-main" ></select>');
                                         $.each(values, function(index, value) { 
                                           ...
                                           obj.find('.uifm-input2-wrap').append('<span class="uifm_frm_price_lbl_cont"></span>');   
                                           
                                            obj.find('.uifm-input2-wrap').find('label .uifm_frm_price_lbl_cont').html(rocketform.pricesettings_labelformat($('#'+f_id)));    
                        ...
                        this.input2settings_import_bulkdata=function(){
