...
if(ZIGAFORM_C_LITE===1){
    require.config({
        ...
        paths: {
            ...
            'flatpickr': 'assets/common/js/flatpickr/4.6.2/flatpickr',
            'flatpickr_moment': 'assets/common/js/flatpickr/4.5.2/l10n/all-lang',
            'moment': 'assets/backend/js/bdatetime/4.7.14/moment-with-locales',
            'b_dtpicker2': 'assets/backend/js/bdatetime/4.7.14/bootstrap-datetimepicker',
            ...
            'acclib':'assets/common/js/accounting/accounting',
       ...
       waitSeconds: 0, 
       map: {
           // '*' means all modules will get 'blueimp-gallery'
          // for their 'blueimp-gallery' dependency.
            '*': {
    ...
    function(jQuery) {
         (function ($uifm) {
                 ...
                 */
                 window.$uifm = $uifm;
                  //window.$uifm = $uifm = $;
                require(['b_slider','script1','b_touchspin','b_switch','bootstrap','flatpickr','flatpickr_moment','b_dtpicker2','b_star','b_cpicker','j_form','acclib','blueimp-gallery','blueimp-gallery-jquery','b_selpicker','iframescript','b_checkradios','b_jasny','placeholder'], 
               function(slider,script,TouchSpin,BootstrapSwitch,_bootstrap,flatpickr,flatpickr_moment,datetimepicker,rating,colorpicker,ajaxSubmit,accounting,blueimpgal,selectpicker,iframescript) {
    ...
    function(jQuery) {
         (function ($uifm) {
                 ...
                 */
                 window.$uifm = $uifm;
                  //window.$uifm = $uifm = $;
                require(['b_slider','script1','b_touchspin','b_switch','bootstrap','flatpickr','flatpickr_moment','b_dtpicker2','b_star','b_cpicker','j_form','acclib','blueimp-gallery','blueimp-gallery-jquery','b_selpicker','waypoints','iframescript','b_checkradios','b_jasny','placeholder'], 
               function(slider,script,TouchSpin,BootstrapSwitch,_bootstrap,flatpickr,flatpickr_moment,datetimepicker,rating,colorpicker,ajaxSubmit,accounting,blueimpgal,selectpicker,waypoints,iframescript) {
                     _zgfm_loader_form(script,blueimpgal,accounting);
...
function _zgfm_loader_form(script,blueimpgal,accounting){
...
function uifm_load_cssfiles(){
    ...
    var uifm_loadcssfile = function(cssFilesArr){
        ...
        var uifm_cssFiles = [{id:"uifm_css_font_a",
                          ...
                          , {id:"uifm_css_b_date",
                              href:UIFORM_SRC+'assets/common/js/flatpickr/4.6.2/flatpickr.min.css'}
                          , {id:"uifm_css_b_date_2",
                              href:UIFORM_SRC+'assets/backend/js/bdatetime/4.7.14/bootstrap-datetimepicker.css'}
