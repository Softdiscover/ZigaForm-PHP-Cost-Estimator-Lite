...
//$js1.= file_get_contents(HTDOCS_PATH . '/../backend/js/bdatetime/4.7.14/moment-with-locales.js');
//$js1.= file_get_contents(HTDOCS_PATH . '/../backend/js/bdatetime/4.7.14/bootstrap-datetimepicker.js');
//star rating
...
$js.= file_get_contents(HTDOCS_PATH . '/js/zgfm-front-calc.js');
$js.= file_get_contents(HTDOCS_PATH . '/js/zgfm-front-cost.js');
...
/*sticky lib*/
$js.= file_get_contents(HTDOCS_PATH . '/../common/js/uiform-sticky.js');
