...
if (ZIGAFORM_C_LITE === 1) {
	require.config({
		...
		paths: {
			...
			b_slider: 'assets/backend/js/bslider/10.6.2/bootstrap-slider.min',
			...
			flatpickr_moment: 'assets/common/js/flatpickr/4.6.2/l10n/all-lang',
			moment: 'assets/backend/js/bdatetime/4.17.45/moment-with-locales',
			b_dtpicker2: 'assets/backend/js/bdatetime/4.17.45/bootstrap-datetimepicker',
...
if (ZIGAFORM_C_LITE === 1) {
	require(['jqueryNoConflict'], function(jQuery) {
		(function($uifm) {
			...
			window.$uifm = $uifm;
			//window.$uifm = $uifm = $;
			require(['b_slider', 'script1', 'b_touchspin', 'b_switch', 'bootstrap', 'flatpickr', 'flatpickr_moment', 'b_dtpicker2', 'b_star', 'b_cpicker', 'j_form', 'acclib', 'blueimp-gallery', 'blueimp-gallery-jquery', 'b_selpicker', 'b_selpicker2', 'iframescript', 'wphooks', 'b_checkradios', 'b_jasny', 'placeholder'], function(
				bootstrapSlider,
				script,
				TouchSpin,
				BootstrapSwitch,
	...
	require(['jqueryNoConflict'], function(jQuery) {
		(function($uifm) {
			...
			window.$uifm = $uifm;
			//window.$uifm = $uifm = $;
			require(['b_slider', 'script1', 'b_touchspin', 'b_switch', 'bootstrap', 'flatpickr', 'flatpickr_moment', 'b_dtpicker2', 'b_star', 'b_cpicker', 'j_form', 'acclib', 'blueimp-gallery', 'blueimp-gallery-jquery', 'b_selpicker', 'b_selpicker2', 'waypoints', 'iframescript', 'wphooks', 'b_checkradios', 'b_jasny', 'placeholder'], function(
				bootstrapSlider,
				script,
				TouchSpin,
				BootstrapSwitch,
...
function uifm_load_cssfiles() {
	...
	var uifm_cssFiles = [
		...
		{ id: 'uifm_css_b_date', href: UIFORM_SRC + 'assets/common/js/flatpickr/4.6.2/flatpickr.min.css' },
