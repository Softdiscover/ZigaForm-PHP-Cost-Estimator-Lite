...
//include(HTDOCS_PATH.'/../backend/js/bdatetime/4.7.14/bootstrap-datetimepicker.css');
//rating star
...
include(HTDOCS_PATH.'/../frontend/css/global-cost.css');
include(HTDOCS_PATH.'/../frontend/css/payment.css');
