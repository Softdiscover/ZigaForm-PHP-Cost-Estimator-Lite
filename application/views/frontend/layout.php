...
<html lang="en"  >
  <head>
   ...
   <noscript>
	   Powered by <a href="https://softdiscover.com/zigaform/?uifm_v=<?php echo model_settings::$db_config['version']; ?>&uifm_source=wpzphpce&uifm_medium=frontend" title="PHP Calculator & Cost Estimation" >ZigaForm version <?php echo model_settings::$db_config['version']; ?></a>
   </noscript>
  </head>
