...
<html lang="en" class="uiform-wrap">
  <head>
   ...
   <noscript>
       Powered by <a href="https://www.zigaform.com/?uifm_v=<?php echo model_settings::$db_config['version']; ?>&uifm_source=wpzphpce&uifm_medium=frontend" title="PHP Calculator & Cost Estimation" >ZigaForm version <?php echo model_settings::$db_config['version']; ?></a>
   </noscript>
  </head>
