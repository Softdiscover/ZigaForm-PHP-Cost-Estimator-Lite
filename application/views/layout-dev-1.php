...
?>
 ...
 <script type="text/javascript" src="<?php echo base_url(); ?>assets/backend/js/zgfm-back-calc.js?<?php echo date('YmdHis');?>"></script>
 ...
 <script type="text/javascript" src="<?php echo base_url(); ?>assets/common/js/uiform-sticky.js?<?php echo date('YmdHis');?>"></script>
