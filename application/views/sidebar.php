...
<?php } ?> 
			...
			<li><a href="<?php echo site_url(); ?>addon_mgtranslate/zfad_mgtranslate_back/show_list"><i class="fa fa-globe" aria-hidden="true"></i> <?php echo __( 'Translation Manager', 'FRocket_admin' ); ?></a></li>
	...
	<div id="zgfm-sidebar-show-ver">
		Zigaform Version <?php echo model_settings::$db_config['version']; ?> <?php echo (ZIGAFORM_C_LITE)?'Free':'Pro'; ?>
	</div> 
</div>
