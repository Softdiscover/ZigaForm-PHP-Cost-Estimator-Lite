...
<html lang="en" >
  <head>
	...
	if ( UIFORM_DEBUG === 1 ) {
		...
		<link href="<?php echo base_url(); ?>assets/backend/css/admin-global.debug.css?v<?php echo date( 'YmdHis' ); ?>" rel="stylesheet">

		<?php
	} else {
		?>
		<link href="<?php echo base_url(); ?>assets/backend/css/admin.min.css" rel="stylesheet">
		<link href="<?php echo base_url(); ?>assets/backend/css/admin-global.min.css" rel="stylesheet">
		<?php
	}
   ...
   <?php
	...
	if ( UIFORM_DEBUG === 1 ) {
		...
		<script type="text/javascript" src="<?php echo base_url(); ?>assets/backend/js/admin-global.debug.js?v=<?php echo date( 'YmdHis' ); ?>"></script>
		<?php
	} else {
		?>
		<script type="text/javascript" src="<?php echo base_url(); ?>assets/backend/js/admin-global.min.js"></script>
		<?php
	}
