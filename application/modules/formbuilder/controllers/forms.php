...
class Forms extends BackendController
{
    ...
    public function ajax_integrity_openmodal()
    {
        ...
        $json['modal_body']   = $this->load->view('formbuilder/forms/ajax_integrity_openmodal', $data, true);
        $json['modal_footer'] = $this->load->view('formbuilder/forms/modal1_footer', $data, true);
    ...
    {
        $redirectUrl = '';
        if ((isset($dump_form['app_ver']) && in_array($dump_form['app_ver'], ['7.0.0','7.6.9'], true) ) ||
    ...
    */
            ...
            case 5:
                ...
                ?>
                    ...
                    ?>
                            ...
                            <?php // echo $this->load->view('formbuilder/fields/templates/prevpanel_quickopts2',array(), true); ?>
                        </div>
                    </div>
                                    <?php
                                    $str_output .= ob_get_contents();
    ...
    public function generate_form_container($id, $numtab, $str_output)
    {
        ...
        $data['form_sticky_content'] = $this->generate_form_sticky();
        $data['form_id']             = $id;
    ...
    public function generate_form_sticky()
    {
        $data            = array();
        $data['summbox'] = $this->current_data_summbox;
        return $this->load->view('formbuilder/forms/formhtml_sticky', $data, true);
    }
    ...
    public function ajax_trashformlist_refresh($data)
    {
        ...
        $data2['query']      = $this->model_forms->getListTrashFormsFiltered($data2);
