													   ...
													   <!-- <li >
															<a 
																...
																href="#uiform-settings-tab3-1"
																			  data-toggle="sfdc-tab"><?php echo __( 'Settings', 'FRocket_admin' ); ?></a></li>-->
														...
														<li>
															<a 
																...
																href="#uiform-settings-tab3-4" data-toggle="sfdc-tab" ><?php echo __( 'Summary Box', 'FRocket_admin' ); ?></a></li>
														<!--<li>
															<a 
																class=""
																
																href="#uiform-settings-tab3-5" data-toggle="sfdc-tab" ><?php echo __( 'Unknown', 'FRocket_admin' ); ?></a></li>-->
													</ul>
													...
													<div class="sfdc-tab-content  ">
														...
														<div class="sfdc-tab-pane" id="uiform-settings-tab3-4">
																<div class="uiform-tab-content  scroll-pane-arrows">
																	<div class="uiform-tab-content-inner">
																	   <!--container -->
																		 <?php include( 'settings_form_summbox.php' ); ?>
																		<!--\end container -->
																	</div>
																</div>
															</div>
