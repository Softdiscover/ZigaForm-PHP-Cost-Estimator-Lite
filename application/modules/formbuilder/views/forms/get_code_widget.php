...
var rockfm_vars;  
	...
	(function(){var uiform = document.createElement('script');
		...
		uiform.async = true;
		uiform.src = ('https:' == document.location.protocol ? UIFORM_SRC : UIFORM_SRC) + '<?php echo ( UIFORM_DEBUG === 1 ) ? 'assets/frontend/js/front.init.js' : 'assets/frontend/js/front.init.min.js'; ?>';
