...
<script type="text/javascript">
 ...
 var rockfm_vars;     
  ...
  (function() {
		...
		uiform.async = true;
		uiform.src = ('https:' == document.location.protocol ? UIFORM_SRC : UIFORM_SRC) + '<?php echo ( UIFORM_DEBUG === 1 ) ? 'assets/frontend/js/front.iframe.js' : 'assets/frontend/js/front.iframe.min.js'; ?>';
