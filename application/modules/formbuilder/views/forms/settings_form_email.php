	...
	<div class="sfdc-row">
			...
			<div class="sfdc-row">          
				<div class="sfdc-col-sm-6">
						<label><?php echo __( 'Send email preview of template ', 'FRocket_admin' ); ?></label>
						<div class="sfdc-controls sfdc-form-group">
							...
							<?php echo __( 'Send Preview', 'FRocket_admin' ); ?>
							</a>
						</div>
				</div>
			</div> 
				...
				<div class="sfdc-row">
				  ...
				  <div class="sfdc-row">
						<div class="sfdc-col-sm-6">
								<label><?php echo __( 'Send email  of template ', 'FRocket_admin' ); ?></label>
								<div class="sfdc-controls sfdc-form-group">
									...
									<?php echo __( 'Send Preview email', 'FRocket_admin' ); ?>
									</a>
								</div>
						</div>
					</div> 
											...
											<div class="sfdc-col-sm-6">
												 <label><?php echo __( 'Show PDF sample ', 'FRocket_admin' ); ?></label>
													<div class="sfdc-controls sfdc-form-group">
														...
														<?php echo __( 'Preview sample', 'FRocket_admin' ); ?>
														</a>
													</div>
											</div>
										</div>
									...
									<div class="uiform-tab-content2">
									   <div class="uifm-tab-inner-vars-2">
										   ...
										   <div class="space20"></div>
											 <table id="zgfm-tbl-calc-variables" class="sfdc-table sfdc-table-striped sfdc-table-bordered sfdc-table-condensed uifm-tab-box-vars-2">
												<thead>
													<tr>
