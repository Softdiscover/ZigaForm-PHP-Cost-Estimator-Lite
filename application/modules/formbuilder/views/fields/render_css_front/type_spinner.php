...
ob_start();
?>
   #rockfm_<?php echo $id; ?> .rockfm-inp4-opt-price-lbl,
   #rockfm_<?php echo $id; ?> .rockfm-inp4-opt-price-lbl span{
	...
	<?php
	if ( isset( $input4['skin_maxwidth_st'] ) && intval( $input4['skin_maxwidth_st'] ) === 1 ) {
		?>
	   width:100%;
