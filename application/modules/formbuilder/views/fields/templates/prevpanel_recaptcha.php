...
?>
<div id="<?php echo $id_field; ?>"  data-typefield="27" class="uiform-recaptcha uiform-field uiform-field-childs zgpb-field-template">
                    ...
                    <div class="rkfm-col-sm-10">
                        <div class="uifm-input-container">
                                <div class="uifm-input5-wrap">
                                   <div class="uifm-input-recaptcha" id="uifmobj-<?php echo $id_field; ?>" ></div>
                                </div>
                        </div>
