...
?>
<div id="<?php echo $id_field; ?>"  data-typefield="42" class="uiform-dynradiobtn uiform-field  uiform-field-childs zgpb-field-template">
					...
					<div class="rkfm-col-sm-10">
						<div class="uifm-input-container">
							<div class="uifm-input17-wrap">
							   <div class="uiform-opt-din-rdobox uifm-dradiobtn-group" >
