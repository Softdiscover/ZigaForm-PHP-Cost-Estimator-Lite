 ...
 * @link      http://wordpress-cost-estimator.zigaform.com
 */
class zfaddn_mgtranslate_back extends BackendController
{
    ...
    */
    ...
    {   
        ...
        $query2 = $this->CI->db->query( 'select * from cepf_cest_addon where flag_status=1 and add_name="mgtranslate"' );
