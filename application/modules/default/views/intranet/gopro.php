...
<tr>
<td class="tabco1" ><?php echo __('Sticky summary', 'FRocket_admin');?></td>
<td class="tabco2" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
<td class="tabco3" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
</tr>
</tr>
...
<tr>
<td class="tabco1" ><?php echo __('Math Calculation', 'FRocket_admin');?></td>
<td class="tabco2" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
<td class="tabco3" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
</tr>
<tr>
<td class="tabco1" ><?php echo __('Paypal payment', 'FRocket_admin');?></td>
<td class="tabco2" ><i class="fa fa-times crossSign" aria-hidden="true"></i></td>
<td class="tabco3" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
</tr>
<tr>
<td class="tabco1" ><?php echo __('Invoice feature', 'FRocket_admin');?></td>
<td class="tabco2" ><i class="fa fa-times crossSign" aria-hidden="true"></i></td>
<td class="tabco3" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
</tr>
<tr>
...
<div class="zgfm-page-pro-button-box">
  <div class="sfdc-row">
    <div class="col-sm-12">
      ...
      <p>
          <a href="https://codecanyon.net/item/zigaform-php-calculator-cost-estimation-form-builder/15883447?ref=Softdiscover"
             target="_blank"
             class="btn btn-info btn-lg"><i class="fa fa-cloud-download"></i> <span><?php echo __('DOWNLOAD', 'FRocket_admin');?></span></a>
        <a 
            href="https://codecanyon.net/item/zigaform-php-calculator-cost-estimation-form-builder/15883447?ref=Softdiscover"
             target="_blank"
